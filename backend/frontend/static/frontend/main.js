...
/* components/App.svelte generated by Svelte v3.24.0 */
...
function create_fragment(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      t6 = (0, _internal.text)("Visit the\n    ");
      a = (0, _internal.element)("a");
      a.textContent = "Svelte tutorial";
      t8 = (0, _internal.text)("\n    to learn how to build Svelte apps.");
      (0, _internal.attr_dev)(h1, "class", "svelte-1e9puaw");
      (0, _internal.add_location)(h1, file, 29, 2, 385);
      (0, _internal.attr_dev)(a, "href", "https://svelte.dev/tutorial");
      (0, _internal.add_location)(a, file, 32, 4, 432);
      (0, _internal.add_location)(p, file, 30, 2, 410);
      (0, _internal.attr_dev)(main, "class", "svelte-1e9puaw");
      (0, _internal.add_location)(main, file, 28, 0, 376);
    },
    l: function claim(nodes) {
      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    },
    m: function mount(target, anchor) {
      (0, _internal.append_dev)(document.head, t0);
      (0, _internal.insert_dev)(target, t1, anchor);
      (0, _internal.insert_dev)(target, main, anchor);
      (0, _internal.append_dev)(main, h1);
      (0, _internal.append_dev)(h1, t2);
      (0, _internal.append_dev)(h1, t3);
      (0, _internal.append_dev)(h1, t4);
      (0, _internal.append_dev)(main, t5);
      (0, _internal.append_dev)(main, p);
      (0, _internal.append_dev)(p, t6);
      (0, _internal.append_dev)(p, a);
      (0, _internal.append_dev)(p, t8);
    },
    p: function update(ctx, [dirty]) {
      if (dirty &
      /*name*/
      1) (0, _internal.set_data_dev)(t3,
      /*name*/
      ctx[0]);
    },
    i: _internal.noop,
...
class App extends _internal.SvelteComponentDev {
  constructor(options) {
    super(options);
    if (!document.getElementById("svelte-1e9puaw-style")) add_css();
...
},{"svelte/internal":"../node_modules/svelte/internal/index.mjs","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"index.js":[function(require,module,exports) {
"use strict";
